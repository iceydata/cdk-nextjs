...
class NextjsImage extends aws_lambda_nodejs_1.NodejsFunction {
    constructor(scope, id, props) {
        ...
        const { layers, ...lambdaOptionsWithoutLayers } = lambdaOptions;
        const sharpLayer = new aws_lambda_1.LayerVersion(scope, 'SharpLayer', {
            compatibleRuntimes: [aws_lambda_1.Runtime.NODEJS_18_X],
            compatibleArchitectures: [aws_lambda_1.Architecture.ARM_64],
            code: aws_lambda_1.Code.fromAsset(path_1.join(__dirname, './layers/sharp/SharpLambdaLayer.zip')),
            description: 'Sharp Layer for Node.js and arm64',
        });
        ...
        super(scope, id, {
            ...
            ...lambdaOptionsWithoutLayers,
            layers: [sharpLayer],
            environment: {
                BUCKET_NAME: bucket.bucketName,
                ...lambdaOptionsWithoutLayers?.environment,
            },
        });
